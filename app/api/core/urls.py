...
if settings.DEBUG:
    ...
    # static() vira no-op com DEBUG=False, entao registramos a rota de media
    # explicitamente. Em producao os uploads sao servidos pelo Django/gunicorn
    # (armazenamento em filesystem, conforme decidido para o MVP).
    urlpatterns += [
        re_path(
            r"^media/(?P<path>.*)$",
            serve,
